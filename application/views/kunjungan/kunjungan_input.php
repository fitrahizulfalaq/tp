...
<div class="section mt-2">
    ...
    <div class="section mt-2 mb-5">
        <form action="<?=base_url("kunjungan/addkunjungan")?>" enctype="multipart/form-data" method="post">
            ...
            <div class="form-group boxed" id="ukm" style="visibility: hidden;">
                <div class="input-wrapper">                                     
            ...
            <div class="form-group boxed" id="lainnya" style="visibility: hidden;">
                <div class="input-wrapper">                                     
                    <label class="label" for="name3">Permasalahan yang dihadapi <span id="alert-resume" class="error">*</span></label>
                    <input type="text" id="word" name="masalah" class="form-control" placeholder="Cth. " required>
                    <i class="clear-input">
                        <ion-icon name="close-circle"></ion-icon>
                    </i>                    
                </div>
