	...
	<div class="section mt-2">
		<div class="card text-center">
			<div class="card-body">
				...
				<a href="<?=base_url()?>/assets/files/template/Rencana Kerja Pendampingan 2023.docx" class="btn btn-primary"><ion-icon name="cloud-download-outline"></ion-icon> Download Template Rencana Kerja</a>
			</div>
		</div>
	</div>
